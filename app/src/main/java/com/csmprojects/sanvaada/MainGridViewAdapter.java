...
public class MainGridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            holder.gif = (ImageView) convertView.findViewById(R.id.mainGridViewItemImageVw);
            holder.meaning = (TextView) convertView.findViewById(R.id.mainGridViewItemTextVw);
